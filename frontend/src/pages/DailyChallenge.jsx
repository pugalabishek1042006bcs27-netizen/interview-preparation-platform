...
const DailyChallenge = () => {
  ...
  const handleComplete = async () => {
    ...
    try {
      setSubmitting(true);
      const response = await dailyChallengeAPI.completeDailyChallenge({
        answer: userAnswer,
      });
      ...
      const msg =
        ...
        "Answer evaluation failed. Try to be more specific.";
      toast.error(msg);
    } finally {
      setSubmitting(false);
    }
        ...
        <header className="page-header">
          <div className="page-heading">
            ...
            <p className="page-subtitle">
              Solve one problem every day to build consistent interview
              readiness. The challenge resets every 24 hours.
            </p>
          </div>
                ...
                <div className="form-stack">
                  <div className="field-group">
                    ...
                    <p className="helper-text">
                      Minimum 20 characters required for verification.
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="section-copy">
                          Great job! You've successfully completed today's
                          challenge and maintained your streak.
                        </p>
                      </div>
                    </div>
                  </div>
