...
const MockInterview = () => {
  ...
  const submitAnswer = async () => {
    ...
    try {
      ...
      setStep("feedback");
      // Record the completed session so Progress Tracker stays in sync
      await API.post("/mock/complete", { topic: selectedTopic, answer });
    } catch (error) {
      ...
      <main className="page-content">
        ...
        {step === "select" && (
          <section className="panel">
            ...
            <div
              ...
              style={{ flexWrap: "wrap", gap: "10px", marginBottom: "32px" }}
            >
              {topics.map((topic) => (
                <button
                  key={topic}
        ...
        {step === "answer" && (
          <section className="panel">
            ...
            <div className="field-group">
              ...
              <div style={{ position: "relative" }}>
                <textarea
                  ...
                  style={{
                    border: isListening ? "2px solid var(--blue)" : "",
            ...
            <div style={{ display: "flex", gap: "16px", marginTop: "32px" }}>
              <button className="button-secondary" onClick={resetInterview}>
                Back
              </button>
              <button
                className="button-primary"
                onClick={submitAnswer}
                disabled={loading || (!answer.trim() && !interimText)}
              >
        ...
        {step === "feedback" && (
          <section className="panel">
            ...
            <div className="feedback-card" style={{ marginBottom: "16px" }}>
              <span className="section-badge blue">Question</span>
              <p style={{ fontWeight: 700, marginTop: "8px" }}>{question}</p>
            </div>
            <div
            ...
            >
              <span className="section-badge blue">Transcript</span>
            ...
            >
              <span className="section-badge green">AI Insights</span>
            ...
            <div style={{ display: "flex", gap: "16px", marginTop: "40px" }}>
              ...
              <button className="button-primary" onClick={resetInterview}>
                New Session
              </button>
            </div>
          </section>
